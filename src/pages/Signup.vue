<template>
  <div class="max-w-md">
    <NeonCard>
      <div class="anime-font text-2xl font-black text-white">Sign up</div>
      <p class="mt-2 text-sm text-white/70">Start your first training day.</p>
      ...
      <form class="mt-6 space-y-4" @submit.prevent="onSubmit">
        ...
        <button
          type="submit"
          class="w-full rounded-xl bg-gradient-to-r from-neonPurple via-cyan-500 to-neonOrange px-4 py-3 text-sm font-black text-slate-950 shadow-[0_0_24px_rgba(34,211,238,0.35)] transition hover:brightness-110"
      ...
      <div class="mt-5 text-sm text-white/70">
        ...
        <RouterLink class="text-neonCyan font-semibold hover:underline" to="/login">Login</RouterLink>
      </div>
    </NeonCard>
  </div>
</template>
